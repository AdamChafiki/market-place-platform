...
const Footer = () => (
  <footer className="bg-primary text-primary-foreground">
    <div className="container mx-auto px-6 pb-10 pt-16">
      <div className="max-w-7xl mx-auto grid xl:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <h2 className="font-bold text-2xl">Findora</h2>
          </a>
        ...
        <div className="xl:col-span-2 grid md:grid-cols-3 gap-8 text-sm">
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/aiplatform" className="hover:text-primary-foreground">
                  AI Platform
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/blog" className="hover:text-primary-foreground">
                  Blog
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/aboutus" className="hover:text-primary-foreground">
                  About Us
                </a>
              </li>
              <li>
                <a href="/careers" className="hover:text-primary-foreground">
                  Careers
                </a>
              </li>
              <li>
                <a href="/contactus" className="hover:text-primary-foreground">
                  Contact Us
                </a>
              </li>
            </ul>
      ...
      {/* Bottom Section */}
      <div className="mt-16 border-t border-primary/30 pt-6 text-center text-sm text-primary-foreground">
